...
Product.create(:name => %{The Mythical Man Month and Other Essays on Software Engineering}, 
      ...
      1986 assertion, "There will be no silver bullet within ten years."}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Programming in Haskell}, 
      ...
      paradigm as quickly as possible.' Journal of Functional Programming}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{A First Course in Database Systems}, 
      ...
      &#xBF;}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The C Programming Language (2nd Edition)}, 
      ...
      files and functions}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Algorithmic Problem Solving}, 
      ...
      algorithms!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Computer Science Illuminated}, 
      ...
      comprehensive and complete introduction to computing.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Annotated Turing}, 
      ...
      41.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Elements of Computing Systems}, 
      ...
      Education Supplement}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Real World Haskell}, 
...
Product.create(:name => %{Programming Ruby 1.9}, 
      ...
      declaration syntax, among other exciting new features.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Eloquent Ruby (Addison-Wesley Professional Ruby)}, 
...
Product.create(:name => %{jQuery in Action, Second Edition}, 
      ...
      your copy and download the ebook are found inside the book.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{jQuery Pocket Reference}, 
		   :description => %{Read Less, Learn More}, 
		   :price => 6.30, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{JQuery For Dummies (For Dummies (Computers))}, 
...
Product.create(:name => %{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}, 
      ...
      available in black.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Canon PowerShot SX220 HS Digital Camera - Grey 3.0}, 
      ...
      scuba diving.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Panasonic Lumix FS16 Digital Camera - Black 2.7 inch}, 
...
Product.create(:name => %{Nikon D3000 Digital SLR Camera}, 
      ...
      control increases exposure accuracy.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D5100 Digital SLR Camera}, 
...
Product.create(:name => %{Nikon D7000 Body Only}, 
      ...
      weather -sealed mount available for outdoor photography.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D7000 18-105 VR Kit}, 
		   :description => %{The new Nikon D7000: Ready to fulfil your passion The D7000's increased ISO
      sensitivity (100-6400, extendable up to 25600) ensures exceptional detail with minimal noise
      when capturing fast moving subjects or in poor light situations, even without the flash Click
      here for a larger image The Nikon D7000 is a D-SLR that offers exceptional image quality,
      ...
      weather -sealed mount available for outdoor photography.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D90 Body Only}, 
      ...
      subjects.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{LG 42LK450U 42-inch Widescreen Full HD 1080p LCD TV}, 
      ...
      favourite pictures and videos.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Humax Freeview playback Digital TV Recorder PVR-9150T}, 
...
Product.create(:name => %{Lenovo G570 15.6 inch Notebook (Core i5-2410M, RAM 6GB, HDD 640GB, DVDRW, Windows 7 Home
      Premium) - Black}, 
      ...
      digital audio support), 1 microphone jack 10/100/1000 Gigabit Ethernet}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{New Apple Macbook Pro 13 inch Notebook (Intel Core i5 Dual Core 2.3GHz, 4GB RAM, 320GB
      ...
      and fewer planes, trains and lorries used for transport.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Network Fundamentals, CCNA Exploration Companion Guide Cisco Networking Academy
      Program}, 
      ...
      Academy online curriculum.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Pragmatic Programmer}, 
      ...
      DavidWall, amazon.com}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Peopleware}, 
      ...
      -- Jake Bond}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Code Complete}, 
...
Product.create(:name => %{C Pocket Reference}, 
      ...
      quickly, the new C Pocket Reference is the book you'll want to have.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Modern Operating Systems}, 
      ...
      out of print or unavailable edition of this title.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Absolute Beginner's Guide to C (Other Sams)}, 
      ...
      knowledge.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{C. Answer Book (Prentice Hall Software)}, 
...
Product.create(:name => %{Pandora's Box}, 
      ...
      Shankland of the University of Stirling}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Alan Turing}, 
		   :description => %{'Ten essential books on technology' --New Statesman}, 
		   :price => 6.61, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Essential Turing}, 
      ...
      comprehensive introductions and comments. ( Volker Peckhaus, Zentralblatt MATH 1076
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Man Who Knew Too Much}, 
      ...
      creations and the complexity of the man" ( Daily Telegraph )}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Introduction to Algorithms}, 
      ...
      of Computer Science, University of Virginia}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Seven Languages in Seven Weeks}, 
      ...
      another-or discover a language that may become one of your favorites.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Learn You a Haskell for Great Good!}, 
      ...
      reading Learn You a Haskell for Great Good!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Purely Functional Data Structures}, 
      ...
      significant contribution to the computer science literature." Computing Reviews}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Programming In Scala 2nd Edition}, 
      ...
      features that can make you a better, more productive developer.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Agile Web Development with Rails Pragmatic Programmers}, 
      ...
      of Ruby with substantial functional and performance improvements.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Ruby on Rails 3 Tutorial}, 
      ...
      &#x2014;Allen Ding}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Beginning Ruby}, 
      ...
      GUI-Based Desktop Application Development Useful Ruby Libraries and Gems}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Rails 3 Way (Addison-Wesley Professional Ruby)}, 
      ...
      Lerner, Linux Journal columnist}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The RSpec Book}, 
      ...
      better tests, and deliver better software to happier users.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Metaprogramming Ruby}, 
      ...
      tips, this book is for you.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Design Patterns in Ruby Addison-Wesley Professional Ruby}, 
      ...
      rewarding.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{JavaScript}, 
		   :description => %{Activate Your Web Pages}, 
		   :price => 20.65, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Python Essential Reference (4th Edition) eBook}, 
      ...
      the standard documentation &#xa0;}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Kindle Store").id) 
Product.create(:name => %{Ruby Pocket Reference (Pocket Reference (O'Reilly)) eBook}, 
      ...
      want the facts-fast-Ruby Pocket Reference is your book.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Kindle Store").id) 
Product.create(:name => %{User Stories Applied}, 
      ...
      method: XP, Scrum... or even your own home-grown approach.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Kindle Store").id) 
Product.create(:name => %{The Ruby Way, Second Edition}, 
      ...
      Communications in Austin, Texas, maintaining a large data warehous...}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Kindle Store").id) 
Product.create(:name => %{HTML5 and CSS3}, 
      ...
      fact, it's here already.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{jQuery Cookbook}, 
		   :description => %{Solutions & Examples for jQuery Developers}, 
		   :price => 14.93, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Introducing HTML 5 (Voices That Matter)}, 
      ...
      for your understanding!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Pro ASP.NET MVC 3 Framework 3rd Edition}, 
...
Product.create(:name => %{CSS}, 
      ...
      websites, or refurbish old sites that are due for an upgrade.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Stunning CSS3}, 
      ...
      using scripting}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{JavaScript Pocket Reference Pocket Reference O'Reilly}, 
...
Product.create(:name => %{CSS Pocket Reference}, 
      ...
      busy Web programmers.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{HTML & XHTML Pocket Reference Pocket Reference O'Reilly}, 
		   :description => %{Quick, Comprehensive, Indispensible}, 
		   :price => 6.36, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{CSS Pocket Reference (Pocket Reference (O'Reilly))}, 
		   :description => %{Visual Presentation for the Web}, 
		   :price => 5.14, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{JavaScript and Ajax For Dummies}, 
      ...
      more}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{HTML, XHTML and CSS For Dummies For Dummies Computers}, 
      ...
      HTML, XHTML and CSS For Dummies will help you get the design results you want!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{PHP and MySQL Web Development All-in-one Desk Reference For Dummies}, 
...
Product.create(:name => %{Olympus TRHLC-120 Traveller Hard Leather Case}, 
      ...
      scuffs.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{ABC Products Rechargeable Lithium-Ion Battery Li50b}, 
      ...
      Recorder}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Olympus TRHC-120 Traveller Hard Case}, 
      ...
      or scuffs.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Ex-Pro Olympus Li-50b, Li50b, High Power Plus+ 925mAh 2}, 
      ...
      costs. Suitable for a wide range of Digital Camera's.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Waterproof & Light Weight Black Camera Case for Olympus}, 
      ...
      ZD710,and other cameras with similar size.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Ex-Pro Olympus Li-50B, Li50b Digital Camera Battery}, 
      ...
      Ex-Pro Manufacture Warranty.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Transcend 16GB SDHC Class 10 Memory Card}, 
      ...
      other memory-hungry devices.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Olympus Traveller Accessory Kit 50B for SZ-10}, 
      ...
      usage).}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Canon DCC-1500 Soft Camera Case for PowerShot SX210 IS}, 
		   :description => %{The Canon DCC-1500 Soft Camera Case is compatible with the PowerShot SX210 IS
      Digital Camera.}, 
		   :price => 14.99, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Snug fit Black Waterproof Hard Camera Case for Canon}, 
		   :description => %{Fits Canon Powershot SX210 IS,A1100, A3100,A3000,A495,A490 Digital Cameras. This is
      not an underwater case.}, 
		   :price => 5.99, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Lowepro Rezo 30 Digital Camera Pouch - Burnt Orange}, 
      ...
      Includes SlipLock" attachment tab and adjustable shoulder strap.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Anti-Shock Waterproof Double Protection Black Tough}, 
		   :description => %{This is not an underwater case. It fits Canon SX210, A1100( The SX210 camera is not
      included)}, 
		   :price => 7.99, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Energizer CA5L Digital Camera Battery Equivalent to}, 
		   :description => %{Battery}, 
		   :price => 8.24, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Ex-Pro Canon NB-5L NB5L, High Power Plus+ 2 Year}, 
		   :description => %{Ex-Pro replacement Li-ion Battery. Can be used as a replacement or additional
      battery. Our cell's are manufactured to the highest standard meeting or exceeding the orginal
      manufacturers specification and supplied with a 2 year RTB guarantee. Ex-Pro batteries are
      fully tested and built with lithium-Ion technology to ensure maximum Power and battery life.
      ...
      costs. Suitable for a wide range of Digital Camera's.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Panasonic DMW-PSS13KK Leather Case for FS Series}, 
      ...
      Panasonic for the Lumix Series of Digital Camera.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Panasonic DMW-PSS13XEK Case for the Lumix FS and S}, 
      ...
      belt loop on the back.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{SANDISK 8 GB Secure Digital SDHC Card - Frustration Free Packaging}, 
      ...
      protect your product just as well as traditional packaging.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Panasonic Lumix DMW-PSS13 Genuine Camera Case}, 
		   :description => %{Panasonic Lumix Camera Case Fits FS/FP/FX/ZX(most models) Original Branded
      Case}, 
		   :price => 8.89, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Panasonic Genuine Leather Case for the Panasonic Lumix}, 
      ...
      scratches and scuffs by carrying it in this high quality Panasonic Lumix Case.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Lowepro Altus 10 Small Camera Pouch ideal for Canon}, 
      ...
      Code ALTUS10}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Hama Starter Kit for Nikon D3100 Camera}, 
      ...
      this essential collection of accessories!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{AmazonBasics Wireless Remote Control for Nikon P7000}, 
      ...
      English/French/German/Japanese/Chinese warranty booklet.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D3100}, 
      ...
      flickr.com/groups/nikond3100fromsnapshotstogreatshots.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Nikon D3100 Digital Field Guide}, 
      ...
      purchase. (Digital Photography Enthusiast, July 2011).}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Lowepro Nova 160 AW All Weather Shoulder Bag for}, 
...
Product.create(:name => %{SquareTrade 3-Year Warranty Plus Accident Protection}, 
      ...
      Facts Document}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}, 
      ...
      are compatible with ours. GEM are not in any way associated with any OEM.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D3000 For Dummies For Dummies Lifestyles Paperback}, 
...
Product.create(:name => %{Nikon D3000 Digital Field Guide}, 
      ...
      !}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}, 
		   :description => %{This SLR camera case is specifically designed for most makes and models of SLR
      cameras. The sleekly designed case is made from high quality tough fabric and has excellent
      padding to protect your camera against those scrapes and drops that inevitably happen. It is
      the perfect case for today's SLR camera. This SLR case is supplied with an adjustable non-slip
...
Product.create(:name => %{Nikon D5100 Digital Field Guide}, 
      ...
      capture beautiful images with your new Nikon D5100.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Nikon AF-S DX NIKKOR 55-300mm f/4.5-5.6G VR Lens}, 
      ...
      to increase their zoom range.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon Li-on batteri EN-EL14, VFB10602}, 
		   :description => %{Opladeligt Li-on batteri EN-EL}, 
		   :price => 37.29, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon Li-ion battery EN-EL15, VFB10702}, 
		   :description => %{Li-ion battery for DSLR cameras such as the D7000.- 7.0V- 1900mAh- 14Wh-
      Li-ion}, 
		   :price => 40.19, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}, 
		   :description => %{Nikon 18-200mm VR II lens Front lens Cap Rear lens cap Lens Hood Lens case User
      Guide Warranty}, 
		   :price => 583.95, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Neewer Vertical Battery Grip for Nikon D7000 Digital}, 
      ...
      manual}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon AF-S DX 16-85MM}, 
      ...
      high-resolution SLRs.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{David Busch's Nikon D7000 Guide to Digital SLR Photography}, 
      ...
      pro!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Nikon AF-S DX 35mm f1.8G}, 
      ...
      telephoto.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}, 
      ...
      here, with this great guide.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Hoya 67mm Pro-1 Digital UV Screw in Filter}, 
		   :description => %{Hoya UV Pro 1 Digital 67}, 
		   :price => 27.16, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D7000 Digital Field Guide}, 
      ...
      sidekick when using your D7000!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Nikon ML-L3 Remote Control}, 
      ...
      innovation, precision and optical quality.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon 50mm F1.8D AF Nikkor Lens}, 
      ...
      to the next level without breaking the bank in the process.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon EN-EL3e Rechargeable Battery}, 
		   :description => %{Nikon is a precision optical company with worldwide manufacturing, research and
      marketing capabilities. The Nikon name is equated with extraordinary photographic performance,
      innovation, precision and optical quality.}, 
		   :price => 25.00, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Nikon D90 For Dummies}, 
      ...
      shooting!}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Nikon D90 Companion}, 
      ...
      definition video}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{SquareTrade 3-Year TV Warranty Plus Accident Protection}, 
		   :description => %{Please note: Your Warranty Contract will be delivered via email within 24 hours of
      purchase and not mailed to you. If you don&#x2019;t receive it, please contact 0800 433
      4789 . The purchase of this extended warranty is not a requirement of your Amazon.co.uk
      purchase. These SquareTrade extended warranties are sold and administered by SquareTrade
      ...
      Facts Document}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Designer Habitat Wall Tilt Bracket for 32 - 55 inch LCD}, 
      ...
      Multiple wall fixing points. User manual included.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Premier AV HF0042 Plasma & LCD Glass Stand upto 50" or}, 
      ...
      Holds upto 42" or 50kgs Complies to British safety standard(BS7376:2004)}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Plasma & LCD Glass Stand Up to 42" - Black Glass}, 
      ...
      1.30pm today for despatch tomorrow (Mon-Fri)}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Designer Habitat -Plasma/LED/LCD}, 
      ...
      install and comes with full instructions.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{SquareTrade 5-Year TV Warranty Plus Accident Protection}, 
		   :description => %{Please note: Your Warranty Contract will be delivered via email within 24 hours of
      purchase and not mailed to you. If you don&#x2019;t receive it, please contact 0800 433
      4789 . The purchase of this extended warranty is not a requirement of your Amazon.co.uk
      purchase. These SquareTrade extended warranties are sold and administered by SquareTrade
      ...
      Facts Document}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Strand Gold Plated Scart to Scart Lead 1.5m}, 
      ...
      equipment including TVs, VCRs, DVD players.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Wired--up v1.3A HDMI to HDMI Gold Plated Connectors}, 
		   :description => %{HDMI to HDMI Gold Plated Connectors 1.8m Cable for HD TV's/ Xbox 360/
      PS3}, 
		   :price => 0.32, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Panasonic TX-L32C3B 32-inch Widescreen HD Ready LCD TV}, 
      ...
      TV).}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Humax Foxsat HDR 500GB Freesat HD Satellite Receiver}, 
      ...
      content.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{Humax PVR9300T 320GB Twin Tuner, PVR}, 
      ...
      plug in and play.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Electronics").id) 
Product.create(:name => %{WD My Book Essential 3.0 2 TB External Hard Drive (USB 3.0/2.0)}, 
      ...
      data with password protection and hardware encryption}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Western Digital My Book Mac Edition 2TB USB 2.0 External Hard Drive}, 
      ...
      Western Digital.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Western Digital TV Live HD Media Player}, 
      ...
      controls.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{DVD Minus (16X speed) Inkjet printable spindle 50}, 
      ...
      office}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Western Digital 2TB SATA 6Gbps Power Saving Internal Hard Drive OEM - Caviar Green}, 
      ...
      reliability, and energy conservation.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{WD My Book Live Personal Cloud Storage 2 TB Network Attached Storage}, 
      ...
      mind.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Belkin Neoprene Sleeve For Notebooks Up To 15.6-Inch, Chocolate/tourmaline}, 
      ...
      Warranty.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Belkin F8N204EA Providence Street Case for Notebooks Up to 15.6 inch - Black}, 
      ...
      the back.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Microsoft Office 2010 Home and Student, 3 Users (PC)}, 
...
Product.create(:name => %{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (450-500 Items)}, 
		   :description => %{Please note: Your Warranty Contract will be delivered via email within 24 hours of
      purchase and not mailed to you. If you don&#x2019;t receive it, please contact 0800 433
      4789 . The purchase of this extended warranty is not a requirement of your Amazon.co.uk
      purchase. These SquareTrade extended warranties are sold and administered by SquareTrade
      ...
      Facts Document}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Microsoft Office 2010 Home and Student, 1 User [Product Key Card] (PC)}, 
		   :description => %{Microsoft Office Home and Student 2010 --licensed for noncommercial use, includes:
      Microsoft Excel 2010 Microsoft PowerPoint 2010 Microsoft Word 2010 Microsoft OneNote 2010 With
      Microsoft Office Home and Student 2010, you and your kids can create great schoolwork and home
      projects from multi-page bibliographies to multimedia presentations. Capture ideas and set
      ...
      manage your world from your PC, mobile phone or online.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Software").id) 
Product.create(:name => %{Belkin Neoprene Sleeve For Notebooks Up To 15.6-Inch, Jet/cabernet}, 
		   :description => %{Designed to fit and complement your notebook, these sleeves offer plush-line fabric
      notebook compartments to keep your notebook secure and free from scratching. Its unique,
      asymmetrical zipper design makes it ideal for easy access to your notebook from the top or the
      side. You can use the sleeve inside another bag for easy carrying or on its own for on-site
      use.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black}, 
...
Product.create(:name => %{Office for Mac 2011, Home and Student Edition (1 User, 1Mac)}, 
      ...
      Windows Live ID Certain features require Internet access (fees may apply)}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Software").id) 
Product.create(:name => %{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi}, 
      ...
      life worries.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (900-1000 Items)}, 
		   :description => %{Please note: Your Warranty Contract will be delivered via email within 24 hours of
      purchase and not mailed to you. If you don&#x2019;t receive it, please contact 0800 433
      4789 . The purchase of this extended warranty is not a requirement of your Amazon.co.uk
      purchase. These SquareTrade extended warranties are sold and administered by SquareTrade
      ...
      Facts Document}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{AppleCare Protection Plan for 13 inch MacBook/MacBook Air/MacBook Pro}, 
      ...
      years from your Mac or Apple display purchase date.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Computers & Accessories").id) 
Product.create(:name => %{Routing Protocols and Concepts, CCNA Exploration Companion Guide Cisco Systems Networking
      Academy Program}, 
      ...
      curriculum.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{LAN Switching and Wireless, CCNA Exploration Companion Guide Cisco Systems Networking
      Academy Program}, 
      ...
      complement the Cisco Networking online curriculum.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Accessing the WAN, CCNA Exploration Companion Guide Cisco Systems Networking Academy
      Program}, 
      ...
      curriculum.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Network Fundamentals, CCNA Exploration Labs and Study Guide Cisco Networking Academy
      Program}, 
      ...
      Cisco Networking Academy curriculum.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Modern Systems Analysis and Design}, 
      ...
      reflect the latest trends, information, and practices in the discipline.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Clean Code}, 
      ...
      code.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Refactoring}, 
      ...
      tools.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Programming Pearls (ACM Press)}, 
      ...
      likely to find yourself reading it in the bath. -- Steve Patient}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Design patterns }, 
...
Product.create(:name => %{Slack }, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Management 3.0}, 
...
Product.create(:name => %{Head First Design Patterns}, 
      ...
      Mike James, VSJ, April 2005}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Java How to Program}, 
      ...
      developing and implementing the software for an automated teller machine.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Software Engineering}, 
      ...
      Advanced Software Engineering 4: Software Engineering Management}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{UML Distilled}, 
      ...
      edition of this title.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Head First Java}, 
      ...
      unavailable edition of this title.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Java Pocket Guide (Pocket Guides)}, 
...
Product.create(:name => %{C++ Pocket Reference}, 
      ...
      quick-references to the C++ language available.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Python Pocket Reference Pocket Reference O'Reilly}, 
		   :description => %{Python in Your Pocket}, 
		   :price => 7.15, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{bash Pocket Reference Pocket Reference O'Reilly}, 
      ...
      Options Command Execution Coprocesses Restricted Shells Built-in Commands}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Artificial Intelligence}, 
      ...
      New York Times article, click here.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Operating Systems Design and Implementation}, 
      ...
      teaching.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Concepts, Techniques, and Models of Computer Programming}, 
      ...
      Inc.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Computer Networks}, 
...
Product.create(:name => %{C++}, 
      ...
      it easy to learn to use C++ at your own pace.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{C Programming in Easy Steps}, 
      ...
      programming.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{C for Dummies}, 
      ...
      painlessly.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{HTML, XHTML, and CSS}, 
      ...
      more.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{C. Puzzle Book}, 
...
Product.create(:name => %{Expert C Programming}, 
      ...
      book. -- Jake Bond}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Advanced Programming in the UNIX Environment Addison-Wesley Professional Computing}, 
      ...
      will be even more indispensable.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Computer Architecture}, 
      ...
      20, 2006}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Speech and Language Processing}, 
      ...
      http://www.cs.colorado.edu/~martin/slp.html}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Professional Issues in Information Technology}, 
      ...
      work and community situations and to be aware of their environments.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Systems Analysis and Design with UML}, 
      ...
      built.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Studying Programming (Palgrave Study Guides)}, 
...
Product.create(:name => %{Maths Credit 2011 SQA Past Papers (Standard Grade)}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Staedtler Triplus Colour 323 SB20 Fibre Tip Pens In Desktop Box - 20 Assorted
      Colours}, 
...
Product.create(:name => %{Learning to Program with Alice (w/CD-ROM)}, 
      ...
      work.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{The Essentials of Computer Organization and Architecture}, 
      ...
      Organization and Architecture course.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Discrete Mathematics and Its Applications with MathZone}, 
      ...
      fields.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Schaum's Outline of Probability and Statistics, 3/E Schaum's Outline Series}, 
      ...
      Outlines-Problem Solved.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Object-Oriented Analysis and Design}, 
		   :description => %{"This is an excellent book...a book I greatly enjoyed reading..." (Visual Systems
      Journal, October 2005)}, 
		   :price => 33.19, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Human Computer Interaction}, 
      ...
      practice.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Applying UML and Patterns}, 
      ...
      maintainable.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Organizational Behaviour Plus Companion Website Access Card}, 
      ...
      testbank.}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Internet and World Wide Web}, 
...
Product.create(:name => %{Colossus}, 
      ...
      computer technology."--Human-Computer Interaction International News}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Codebreakers}, 
      ...
      it."--Robert Harris}, 
		   ...
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Station X}, 
		   :description => %{gfdgdg}, 
		   :price => 2.81, 
		   :manufacturer_id => Manufacturer.first.id, 
		   :category_id => Category.find_by_name("Books").id) 
Product.create(:name => %{Secret Days}, 
...
# Photos
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31GBgcA5PML._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Code}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51WIpM70FEL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{The Mythical Man Month and Other Essays on Software Engineering}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41rwtENNgBL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Programming in Haskell}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/21LvRYu-YSL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{A First Course in Database Systems}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51TGEPRTDNL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{The C Programming Language (2nd Edition)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41k9iBLxsqL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Algorithmic Problem Solving}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51W-YaXNAVL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Computer Science Illuminated}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51OId3bQb5L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{The Annotated Turing}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51y65-nCd6L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Elements of Computing Systems}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51I6dXmEFKL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Real World Haskell}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51oDo%2BQKHJL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{The Ruby Programming Language}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51vFypbVAPL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Programming Ruby 1.9}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41KtNo1H-DL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51c3tL7dShL._SL500_AA258_PIkin4,BottomRight,-30,22_AA280_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{The Ruby Programming Language eBook}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41VTNwW9TWL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{jQuery in Action, Second Edition}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41TqXJJB2oL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{jQuery Pocket Reference}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51jhzavPtOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{JQuery For Dummies (For Dummies (Computers))}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41NflxbzxxL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Olympus SZ-10 Digital Camera - Black 3.0 inch LCD}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/418UPpkH6tL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/4103madSZ%2BL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Canon PowerShot SX220 HS Digital Camera - Grey 3.0}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51sIW-4Z7fL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Panasonic Lumix FS16 Digital Camera - Black 2.7 inch}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/515cImXYaxL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D3100 18-55vr Kit}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41eP4KInalL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D3000 Digital SLR Camera}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41AP1FRW4YL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D5100 Digital SLR Camera}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51QaUtKfHbL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D7000 Body Only}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41p8fEXmnuL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51QNs7A7r0L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D90 Body Only}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41p1HESlZwL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{LG 42LK450U 42-inch Widescreen Full HD 1080p LCD TV}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31Ks%2Bsy1tcL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Humax Freeview playback Digital TV Recorder PVR-9150T}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31UkWrSrq8L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{My Book Essential WDBAAF0020HBK - Hard drive - 2 TB - external - Hi-Speed USB}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41-wWTzAeML._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Lenovo G570 15.6 inch Notebook (Core i5-2410M, RAM 6GB, HDD 640GB, DVDRW, Windows 7 Home
      Premium) - Black}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/419eHFlskkL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{New Apple Macbook Pro 13 inch Notebook (Intel Core i5 Dual Core 2.3GHz, 4GB RAM, 320GB
      HDD, Up to 7 hrs battery life) - Launched February 2011}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51QjJK4I8XL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Network Fundamentals, CCNA Exploration Companion Guide Cisco Networking Academy
      Program}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41HXiIojloL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{The Pragmatic Programmer}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51MlUgcSICL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Peopleware}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51nWkLCu1SL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Code Complete}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41i7MxLPIaL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Introduction to Java Programming, Comprehensive}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41Sl1Tum67L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{C Pocket Reference}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/418WBniVP-L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Modern Operating Systems}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51lg5JNal3L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/416Te4p4YpL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HGo4MjkZL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Computer Organization and Design}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HTa9sp-CL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Exploring Wonderland}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51a1AxprMNL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Java for Everyone}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/413-OHFRWKL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Pandora's Box}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51Bace34YQL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{The Alan Turing}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/519P3W7LBNL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{The Essential Turing}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41-I%2Bp%2BUiYL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{The Man Who Knew Too Much}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41roHsC7F4L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Introduction to Algorithms}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51C%2BJGTYWbL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Seven Languages in Seven Weeks}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41-CJxuUV%2BL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Learn You a Haskell for Great Good!}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41XlPaC%2BZqL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Purely Functional Data Structures}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51w1YjEaT-L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Programming In Scala 2nd Edition}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51Pkt8UcdAL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Agile Web Development with Rails Pragmatic Programmers}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51TEzGZ%2BggL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Ruby on Rails 3 Tutorial}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/512242IrWmL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Beginning Ruby}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41CsLULhOfL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51tFzC0fFZL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{The RSpec Book}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41ygBmdaIfL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Metaprogramming Ruby}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51kExzC-67L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Design Patterns in Ruby Addison-Wesley Professional Ruby}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51WD-F3GobL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{JavaScript}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41wFtSK7t2L._SL500_AA258_PIkin4,BottomRight,-43,22_AA280_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Python Essential Reference (4th Edition) eBook}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41izyC2aXYL._SL500_AA258_PIkin4,BottomRight,-50,22_AA280_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Ruby Pocket Reference (Pocket Reference (O'Reilly)) eBook}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51BzIIaznpL._SL500_AA258_PIkin4,BottomRight,-31,22_AA280_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{User Stories Applied}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/413K6WbfbjL._SL500_AA258_PIkin4,BottomRight,-31,22_AA280_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{The Ruby Way, Second Edition}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51rGLcXiuNL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{HTML5 and CSS3}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/513BcG%2BGZDL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{jQuery Cookbook}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31eSqTFIaFL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/515GwPEj8gL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Pro ASP.NET MVC 3 Framework 3rd Edition}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41SwXc5CPUL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{CSS}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/417DebeFMkL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Stunning CSS3}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51zjJBw5OwL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{JavaScript Pocket Reference Pocket Reference O'Reilly}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51ZOekO77hL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{CSS Pocket Reference}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51cv5koB8FL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{HTML & XHTML Pocket Reference Pocket Reference O'Reilly}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51h6SQFRsKL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{CSS Pocket Reference (Pocket Reference (O'Reilly))}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/510ajQUIM6L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{JavaScript and Ajax For Dummies}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51uuI%2BDdplL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{HTML, XHTML and CSS For Dummies For Dummies Computers}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HcVqDTAUL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{PHP and MySQL Web Development All-in-one Desk Reference For Dummies}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41xoUXdWINL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{jQuery}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51ajRCcFnuL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41HUR6i5aOL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{ABC Products Rechargeable Lithium-Ion Battery Li50b}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51He98iFTGL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Olympus TRHC-120 Traveller Hard Case}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41K4b6dBIVL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Ex-Pro Olympus Li-50b, Li50b, High Power Plus+ 925mAh 2}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51-CcLzzTJL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Waterproof & Light Weight Black Camera Case for Olympus}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/418kdwLF6QL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Ex-Pro Olympus Li-50B, Li50b Digital Camera Battery}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41HhhTcP0bL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51He98iFTGL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Olympus Traveller Accessory Kit 50B for SZ-10}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/411V6qUP5bL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Canon DCC-1500 Soft Camera Case for PowerShot SX210 IS}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/417dGDY9AYL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Snug fit Black Waterproof Hard Camera Case for Canon}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41cftvWID-L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Lowepro Rezo 30 Digital Camera Pouch - Burnt Orange}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/310-D8jKiyL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Anti-Shock Waterproof Double Protection Black Tough}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51AoXf1fdQL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Energizer CA5L Digital Camera Battery Equivalent to}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41FFZfaG3GL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Ex-Pro Canon NB-5L NB5L, High Power Plus+ 2 Year}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31QFpza9%2BvL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Panasonic DMW-PSS13KK Leather Case for FS Series}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41C8s2v0hvL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Panasonic DMW-PSS13XEK Case for the Lumix FS and S}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41Y-MhculiL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{SANDISK 8 GB Secure Digital SDHC Card - Frustration Free Packaging}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41opyETc%2B6L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Panasonic Lumix DMW-PSS13 Genuine Camera Case}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/21FsWN86qsL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Panasonic Genuine Leather Case for the Panasonic Lumix}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31OB9WCovvL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Lowepro Altus 10 Small Camera Pouch ideal for Canon}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51VJ3-OqiqL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41d48PfSqjL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{AmazonBasics Wireless Remote Control for Nikon P7000}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/515AXIU1M4L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D3100}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/5190XR2yqaL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D3100 Digital Field Guide}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41SM8BGAjvL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Lowepro Nova 160 AW All Weather Shoulder Bag for}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HDv0OyieL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{SquareTrade 3-Year Warranty Plus Accident Protection}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51BiMoxjwFL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51Ag2bt5H-L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D3000 For Dummies For Dummies Lifestyles Paperback}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31vJRLT3HFL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Lig0sh}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51qNpGD49nL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D3000}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51WVjhsF0iL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D3000 Digital Field Guide}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51BiMoxjwFL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51ziwQCCFAL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D5100 For Dummies (For Dummies (Computers))}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51uXiXwWvxL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D5100 Digital Field Guide}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41FV5XfqEvL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon AF-S DX NIKKOR 55-300mm f/4.5-5.6G VR Lens}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31YoucP-1uL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41JPFRh%2Bc2L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41%2BCbW6EgnL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31KwDWnRvRL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/516wPz9GtEL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon AF-S DX 16-85MM}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51WThdhpkIL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{David Busch's Nikon D7000 Guide to Digital SLR Photography}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41CEOa4NmTL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon AF-S DX 35mm f1.8G}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HX6wf5O3L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/417WByDBYtL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Hoya 67mm Pro-1 Digital UV Screw in Filter}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51I5zhrCdAL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D7000 Digital Field Guide}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41TpK4N5N6L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon ML-L3 Remote Control}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51CnjgPJ%2BjL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon 50mm F1.8D AF Nikkor Lens}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31V3ADN9TBL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon EN-EL3e Rechargeable Battery}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51k%2BPHE1BEL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Nikon D90 For Dummies}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51iLztBblTL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{The Nikon D90 Companion}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HDv0OyieL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{SquareTrade 3-Year TV Warranty Plus Accident Protection}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31qcsd1wUGL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Designer Habitat Wall Tilt Bracket for 32 - 55 inch LCD}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41zf5lMepGL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Premier AV HF0042 Plasma & LCD Glass Stand upto 50" or}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41B61DQOgTL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Plasma & LCD Glass Stand Up to 42" - Black Glass}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31UCPZOyzbL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Designer Habitat -Plasma/LED/LCD}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51DzfCD4NIL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{SquareTrade 5-Year TV Warranty Plus Accident Protection}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/4176ZS96W9L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Strand Gold Plated Scart to Scart Lead 1.5m}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/415yUGy2SfL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Wired--up v1.3A HDMI to HDMI Gold Plated Connectors}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41V%2BPJNreqL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Panasonic TX-L32C3B 32-inch Widescreen HD Ready LCD TV}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31O7GIBQtxL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Humax Foxsat HDR 500GB Freesat HD Satellite Receiver}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31G6QYbVFPL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Humax PVR9300T 320GB Twin Tuner, PVR}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31L5klk5oeL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{WD My Book Essential 3.0 2 TB External Hard Drive (USB 3.0/2.0)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/21RkVgrWujL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Western Digital My Book Mac Edition 2TB USB 2.0 External Hard Drive}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/417mw6e7UvL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Western Digital TV Live HD Media Player}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31QE9vcK2%2BL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{DVD Minus (16X speed) Inkjet printable spindle 50}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41wqVYC86UL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Western Digital 2TB SATA 6Gbps Power Saving Internal Hard Drive OEM - Caviar Green}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31GV10OL%2BlL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{WD My Book Live Personal Cloud Storage 2 TB Network Attached Storage}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/21AfBQwqUPL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Belkin Neoprene Sleeve For Notebooks Up To 15.6-Inch, Chocolate/tourmaline}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/21LCfss4crL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Belkin F8N204EA Providence Street Case for Notebooks Up to 15.6 inch - Black}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41cgP%2BUBgvL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Microsoft Office 2010 Home and Student, 3 Users (PC)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HDv0OyieL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (450-500 Items)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41FufTm6Z3L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Microsoft Office 2010 Home and Student, 1 User [Product Key Card] (PC)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/2193aSqPMTL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Belkin Neoprene Sleeve For Notebooks Up To 15.6-Inch, Jet/cabernet}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31e69CbHTsL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41PN1CYA0RL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Office for Mac 2011, Home and Student Edition (1 User, 1Mac)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/21sof3YJ9jL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51HDv0OyieL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (900-1000 Items)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31JK6tN8T9L._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{AppleCare Protection Plan for 13 inch MacBook/MacBook Air/MacBook Pro}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31XnU8U91QL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Routing Protocols and Concepts, CCNA Exploration Companion Guide Cisco Systems Networking
      Academy Program}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51Tv4lpJKIL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{LAN Switching and Wireless, CCNA Exploration Companion Guide Cisco Systems Networking
      Academy Program}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51vPa9rjRuL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Accessing the WAN, CCNA Exploration Companion Guide Cisco Systems Networking Academy
      Program}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41nIUvEljsL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Network Fundamentals, CCNA Exploration Labs and Study Guide Cisco Networking Academy
      Program}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41OB1vIDVUL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Modern Systems Analysis and Design}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41znMZniZ1L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Clean Code}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51T4YZ3HieL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Refactoring}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41ETT7KQRRL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Programming Pearls (ACM Press)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51Q-RLSadrL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Design patterns }).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/513Jes0CBKL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Slack }).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51dtvyU2b4L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Management 3.0}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51Q6l%2BMyLgL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Head First Design Patterns}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/61HcHvW4JIL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Java How to Program}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/517enbDKK7L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Software Engineering}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51N90Q8iwnL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{UML Distilled}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51a1RPCmv7L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Head First Java}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/5176Hqjno2L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41tfvZgFIiL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{C++ Pocket Reference}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51O2eIVhIOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Python Pocket Reference Pocket Reference O'Reilly}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51QvoPPPMxL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{bash Pocket Reference Pocket Reference O'Reilly}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51PfWyaZxkL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Artificial Intelligence}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/21Np4yEIzwL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Operating Systems Design and Implementation}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51JGRqYyy%2BL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Concepts, Techniques, and Models of Computer Programming}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/516PKzMgc7L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Computer Networks}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51IWmNxF2tL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{C++}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41DZbYjkZ2L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{C Programming in Easy Steps}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/516VkSVE0ZL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{C for Dummies}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51ID6MKVMOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{HTML, XHTML, and CSS}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/413Y85XXXWL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{C. Puzzle Book}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41srLM7zoEL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{C Programming}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41186C2QEZL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Expert C Programming}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51LYZX2quyL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Advanced Programming in the UNIX Environment Addison-Wesley Professional Computing}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/515a1tC7sOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Computer Architecture}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51KDxLZyd5L._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Speech and Language Processing}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/410V6ZCZ8DL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Professional Issues in Information Technology}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/61TuLDldmmL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Systems Analysis and Design with UML}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51TJQ9MPDYL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Studying Programming (Palgrave Study Guides)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51AhNTc66DL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Maths Credit 2011 SQA Past Papers (Standard Grade)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51LMuSwq2KL._SL500_AA280_.jpg", 
		 :product_id => Product.find_by_name(%{Staedtler Triplus Colour 323 SB20 Fibre Tip Pens In Desktop Box - 20 Assorted
      Colours}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/519nAd3oCXL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Learning to Program with Alice (w/CD-ROM)}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/515Q48TJQAL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{The Essentials of Computer Organization and Architecture}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/31u2ffsdpiL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Discrete Mathematics and Its Applications with MathZone}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51k12tjHPWL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Schaum's Outline of Probability and Statistics, 3/E Schaum's Outline Series}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41C3SZ5DAXL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Object-Oriented Analysis and Design}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/617J74145FL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Human Computer Interaction}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51aukquzeFL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Applying UML and Patterns}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/41VlJoGwzOL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Organizational Behaviour Plus Companion Website Access Card}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/61b%2BS2P3vKL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Internet and World Wide Web}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51Xvl-BY5-L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Enigma}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/412KLgk9qgL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Colossus}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51A8YA2X0DL._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Codebreakers}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51x9a4jPm2L._BO2,204,203,200_PIsitb-sticker-arrow-click,TopRight,35,-76_AA240_SH20_OU02_.jpg", 
		 :product_id => Product.find_by_name(%{Station X}).id )
Photo.create(:url => "http://ecx.images-amazon.com/images/I/51%2BxVp2OMuL._SL500_AA240_.jpg", 
		 :product_id => Product.find_by_name(%{Secret Days}).id )

# Produtos relacionados
puts Product.find_by_name(%{Code}).name
puts Product.find_by_name(%{Computer Science Illuminated}).name
Product.find_by_name(%{Code}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{Code}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Code}).related_products.push Product.find_by_name(%{Algorithmic Problem Solving})
Product.find_by_name(%{The Mythical Man Month and Other Essays on Software Engineering}).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{The Mythical Man Month and Other Essays on Software Engineering}).related_products.push Product.find_by_name(%{Programming in Haskell})
Product.find_by_name(%{The Mythical Man Month and Other Essays on Software Engineering}).related_products.push Product.find_by_name(%{A First Course in Database Systems})
Product.find_by_name(%{Programming in Haskell}).related_products.push Product.find_by_name(%{A First Course in Database Systems})
Product.find_by_name(%{Programming in Haskell}).related_products.push Product.find_by_name(%{Real World Haskell})
Product.find_by_name(%{Programming in Haskell}).related_products.push Product.find_by_name(%{Algorithmic Problem Solving})
Product.find_by_name(%{A First Course in Database Systems}).related_products.push Product.find_by_name(%{Programming in Haskell})
Product.find_by_name(%{A First Course in Database Systems}).related_products.push Product.find_by_name(%{Algorithmic Problem Solving})
Product.find_by_name(%{The C Programming Language (2nd Edition)}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{The C Programming Language (2nd Edition)}).related_products.push Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)})
Product.find_by_name(%{The C Programming Language (2nd Edition)}).related_products.push Product.find_by_name(%{C. Answer Book (Prentice Hall Software)})
Product.find_by_name(%{Algorithmic Problem Solving}).related_products.push Product.find_by_name(%{Programming in Haskell})
Product.find_by_name(%{Algorithmic Problem Solving}).related_products.push Product.find_by_name(%{A First Course in Database Systems})
Product.find_by_name(%{Algorithmic Problem Solving}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Computer Science Illuminated}).related_products.push Product.find_by_name(%{Java for Everyone})
Product.find_by_name(%{The Annotated Turing}).related_products.push Product.find_by_name(%{The Essential Turing})
Product.find_by_name(%{Elements of Computing Systems}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Elements of Computing Systems}).related_products.push Product.find_by_name(%{Introduction to Algorithms})
Product.find_by_name(%{Elements of Computing Systems}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{Real World Haskell}).related_products.push Product.find_by_name(%{Programming in Haskell})
Product.find_by_name(%{Real World Haskell}).related_products.push Product.find_by_name(%{Purely Functional Data Structures})
Product.find_by_name(%{Real World Haskell}).related_products.push Product.find_by_name(%{Programming In Scala 2nd Edition})
Product.find_by_name(%{The Ruby Programming Language}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Programming Ruby 1.9}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Programming Ruby 1.9}).related_products.push Product.find_by_name(%{The Ruby Programming Language})
Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{jQuery in Action, Second Edition}).related_products.push Product.find_by_name(%{jQuery Cookbook})
Product.find_by_name(%{jQuery in Action, Second Edition}).related_products.push Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)})
Product.find_by_name(%{jQuery in Action, Second Edition}).related_products.push Product.find_by_name(%{Pro ASP.NET MVC 3 Framework 3rd Edition})
Product.find_by_name(%{jQuery Pocket Reference}).related_products.push Product.find_by_name(%{jQuery Cookbook})
Product.find_by_name(%{JQuery For Dummies (For Dummies (Computers))}).related_products.push Product.find_by_name(%{JavaScript and Ajax For Dummies})
Product.find_by_name(%{JQuery For Dummies (For Dummies (Computers))}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{Olympus SZ-10 Digital Camera - Black 3.0 inch LCD}).related_products.push Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case})
Product.find_by_name(%{Olympus SZ-10 Digital Camera - Black 3.0 inch LCD}).related_products.push Product.find_by_name(%{Olympus TRHC-120 Traveller Hard Case})
Product.find_by_name(%{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}).related_products.push Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case})
Product.find_by_name(%{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}).related_products.push Product.find_by_name(%{Olympus TRHC-120 Traveller Hard Case})
Product.find_by_name(%{Olympus SZ-30MR Digital Camera - Silver 3.0 inch LCD}).related_products.push Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card})
Product.find_by_name(%{Canon PowerShot SX220 HS Digital Camera - Grey 3.0}).related_products.push Product.find_by_name(%{Lowepro Rezo 30 Digital Camera Pouch - Burnt Orange})
Product.find_by_name(%{Panasonic Lumix FS16 Digital Camera - Black 2.7 inch}).related_products.push Product.find_by_name(%{Panasonic DMW-PSS13KK Leather Case for FS Series})
Product.find_by_name(%{Panasonic Lumix FS16 Digital Camera - Black 2.7 inch}).related_products.push Product.find_by_name(%{Panasonic Lumix DMW-PSS13 Genuine Camera Case})
Product.find_by_name(%{Nikon D3100 18-55vr Kit}).related_products.push Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera})
Product.find_by_name(%{Nikon D3100 18-55vr Kit}).related_products.push Product.find_by_name(%{Nikon D3100 Digital Field Guide})
Product.find_by_name(%{Nikon D3000 Digital SLR Camera}).related_products.push Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000})
Product.find_by_name(%{Nikon D3000 Digital SLR Camera}).related_products.push Product.find_by_name(%{Nikon D3000 Digital Field Guide})
Product.find_by_name(%{Nikon D5100 Digital SLR Camera}).related_products.push Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000})
Product.find_by_name(%{Nikon D5100 Digital SLR Camera}).related_products.push Product.find_by_name(%{Nikon D5100 Digital Field Guide})
Product.find_by_name(%{Nikon D5100 Digital SLR Camera}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{Nikon D7000 Body Only}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{Nikon D7000 Body Only}).related_products.push Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens})
Product.find_by_name(%{Nikon D7000 Body Only}).related_products.push Product.find_by_name(%{Nikon AF-S DX 16-85MM})
Product.find_by_name(%{Nikon D7000 Body Only}).related_products.push Product.find_by_name(%{Nikon AF-S DX 35mm f1.8G})
Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).related_products.push Product.find_by_name(%{Hoya 67mm Pro-1 Digital UV Screw in Filter})
Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).related_products.push Product.find_by_name(%{Nikon D7000 Digital Field Guide})
Product.find_by_name(%{Nikon D7000 18-105 VR Kit}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{Nikon D90 Body Only}).related_products.push Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens})
Product.find_by_name(%{Nikon D90 Body Only}).related_products.push Product.find_by_name(%{Nikon 50mm F1.8D AF Nikkor Lens})
Product.find_by_name(%{Nikon D90 Body Only}).related_products.push Product.find_by_name(%{Nikon EN-EL3e Rechargeable Battery})
Product.find_by_name(%{Nikon D90 Body Only}).related_products.push Product.find_by_name(%{Nikon D90 For Dummies})
Product.find_by_name(%{Nikon D90 Body Only}).related_products.push Product.find_by_name(%{The Nikon D90 Companion})
Product.find_by_name(%{Humax Freeview playback Digital TV Recorder PVR-9150T}).related_products.push Product.find_by_name(%{Strand Gold Plated Scart to Scart Lead 1.5m})
Product.find_by_name(%{Humax Freeview playback Digital TV Recorder PVR-9150T}).related_products.push Product.find_by_name(%{Humax PVR9300T 320GB Twin Tuner, PVR})
Product.find_by_name(%{My Book Essential WDBAAF0020HBK - Hard drive - 2 TB - external - Hi-Speed USB}).related_products.push Product.find_by_name(%{Western Digital TV Live HD Media Player})
Product.find_by_name(%{My Book Essential WDBAAF0020HBK - Hard drive - 2 TB - external - Hi-Speed USB}).related_products.push Product.find_by_name(%{DVD Minus (16X speed) Inkjet printable spindle 50})
Product.find_by_name(%{Lenovo G570 15.6 inch Notebook (Core i5-2410M, RAM 6GB, HDD 640GB, DVDRW, Windows 7 Home
      Premium) - Black}).related_products.push Product.find_by_name(%{Microsoft Office 2010 Home and Student, 3 Users (PC)})
Product.find_by_name(%{New Apple Macbook Pro 13 inch Notebook (Intel Core i5 Dual Core 2.3GHz, 4GB RAM, 320GB
      HDD, Up to 7 hrs battery life) - Launched February 2011}).related_products.push Product.find_by_name(%{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black})
Product.find_by_name(%{New Apple Macbook Pro 13 inch Notebook (Intel Core i5 Dual Core 2.3GHz, 4GB RAM, 320GB
      HDD, Up to 7 hrs battery life) - Launched February 2011}).related_products.push Product.find_by_name(%{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi})
Product.find_by_name(%{Network Fundamentals, CCNA Exploration Companion Guide Cisco Networking Academy
      Program}).related_products.push Product.find_by_name(%{Modern Systems Analysis and Design})
Product.find_by_name(%{Network Fundamentals, CCNA Exploration Companion Guide Cisco Networking Academy
      Program}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{The Pragmatic Programmer}).related_products.push Product.find_by_name(%{Programming Pearls (ACM Press)})
Product.find_by_name(%{Peopleware}).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Code Complete}).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Code Complete}).related_products.push Product.find_by_name(%{Head First Design Patterns})
Product.find_by_name(%{Introduction to Java Programming, Comprehensive}).related_products.push Product.find_by_name(%{A First Course in Database Systems})
Product.find_by_name(%{Introduction to Java Programming, Comprehensive}).related_products.push Product.find_by_name(%{Head First Java})
Product.find_by_name(%{Introduction to Java Programming, Comprehensive}).related_products.push Product.find_by_name(%{Java Pocket Guide (Pocket Guides)})
Product.find_by_name(%{C Pocket Reference}).related_products.push Product.find_by_name(%{C++ Pocket Reference})
Product.find_by_name(%{C Pocket Reference}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{C Pocket Reference}).related_products.push Product.find_by_name(%{Java Pocket Guide (Pocket Guides)})
Product.find_by_name(%{C Pocket Reference}).related_products.push Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)})
Product.find_by_name(%{Modern Operating Systems}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Modern Operating Systems}).related_products.push Product.find_by_name(%{Operating Systems Design and Implementation})
Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).related_products.push Product.find_by_name(%{C Programming in Easy Steps})
Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)}).related_products.push Product.find_by_name(%{C for Dummies})
Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).related_products.push Product.find_by_name(%{C. Puzzle Book})
Product.find_by_name(%{C. Answer Book (Prentice Hall Software)}).related_products.push Product.find_by_name(%{Expert C Programming})
Product.find_by_name(%{Computer Organization and Design}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Computer Organization and Design}).related_products.push Product.find_by_name(%{Professional Issues in Information Technology})
Product.find_by_name(%{Computer Organization and Design}).related_products.push Product.find_by_name(%{Systems Analysis and Design with UML})
Product.find_by_name(%{Exploring Wonderland}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{Exploring Wonderland}).related_products.push Product.find_by_name(%{Studying Programming (Palgrave Study Guides)})
Product.find_by_name(%{Java for Everyone}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{Pandora's Box}).related_products.push Product.find_by_name(%{Human Computer Interaction})
Product.find_by_name(%{Pandora's Box}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{Introduction to Algorithms}).related_products.push Product.find_by_name(%{Programming Pearls (ACM Press)})
Product.find_by_name(%{Seven Languages in Seven Weeks}).related_products.push Product.find_by_name(%{Programming In Scala 2nd Edition})
Product.find_by_name(%{Learn You a Haskell for Great Good!}).related_products.push Product.find_by_name(%{Real World Haskell})
Product.find_by_name(%{Learn You a Haskell for Great Good!}).related_products.push Product.find_by_name(%{Programming In Scala 2nd Edition})
Product.find_by_name(%{Purely Functional Data Structures}).related_products.push Product.find_by_name(%{Real World Haskell})
Product.find_by_name(%{Purely Functional Data Structures}).related_products.push Product.find_by_name(%{Programming In Scala 2nd Edition})
Product.find_by_name(%{Agile Web Development with Rails Pragmatic Programmers}).related_products.push Product.find_by_name(%{The Ruby Programming Language})
Product.find_by_name(%{Agile Web Development with Rails Pragmatic Programmers}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Ruby on Rails 3 Tutorial}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Ruby on Rails 3 Tutorial}).related_products.push Product.find_by_name(%{The Ruby Programming Language})
Product.find_by_name(%{Ruby on Rails 3 Tutorial}).related_products.push Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Beginning Ruby}).related_products.push Product.find_by_name(%{The Ruby Programming Language})
Product.find_by_name(%{Beginning Ruby}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)}).related_products.push Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{The RSpec Book}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{The RSpec Book}).related_products.push Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Metaprogramming Ruby}).related_products.push Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Design Patterns in Ruby Addison-Wesley Professional Ruby}).related_products.push Product.find_by_name(%{Eloquent Ruby (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{Design Patterns in Ruby Addison-Wesley Professional Ruby}).related_products.push Product.find_by_name(%{The Rails 3 Way (Addison-Wesley Professional Ruby)})
Product.find_by_name(%{JavaScript}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{JavaScript}).related_products.push Product.find_by_name(%{jQuery Cookbook})
Product.find_by_name(%{JavaScript}).related_products.push Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)})
Product.find_by_name(%{Python Essential Reference (4th Edition) eBook}).related_products.push Product.find_by_name(%{Real World Haskell})
Product.find_by_name(%{HTML5 and CSS3}).related_products.push Product.find_by_name(%{jQuery in Action, Second Edition})
Product.find_by_name(%{HTML5 and CSS3}).related_products.push Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)})
Product.find_by_name(%{HTML5 and CSS3}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{jQuery Cookbook}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{jQuery Cookbook}).related_products.push Product.find_by_name(%{jQuery in Action, Second Edition})
Product.find_by_name(%{jQuery Cookbook}).related_products.push Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)})
Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)}).related_products.push Product.find_by_name(%{jQuery in Action, Second Edition})
Product.find_by_name(%{Pro ASP.NET MVC 3 Framework 3rd Edition}).related_products.push Product.find_by_name(%{jQuery in Action, Second Edition})
Product.find_by_name(%{CSS}).related_products.push Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)})
Product.find_by_name(%{CSS}).related_products.push Product.find_by_name(%{jQuery in Action, Second Edition})
Product.find_by_name(%{Stunning CSS3}).related_products.push Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)})
Product.find_by_name(%{JavaScript Pocket Reference Pocket Reference O'Reilly}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{CSS Pocket Reference}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{HTML & XHTML Pocket Reference Pocket Reference O'Reilly}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{CSS Pocket Reference (Pocket Reference (O'Reilly))}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{JavaScript and Ajax For Dummies}).related_products.push Product.find_by_name(%{JQuery For Dummies (For Dummies (Computers))})
Product.find_by_name(%{HTML, XHTML and CSS For Dummies For Dummies Computers}).related_products.push Product.find_by_name(%{JavaScript and Ajax For Dummies})
Product.find_by_name(%{PHP and MySQL Web Development All-in-one Desk Reference For Dummies}).related_products.push Product.find_by_name(%{JavaScript and Ajax For Dummies})
Product.find_by_name(%{jQuery}).related_products.push Product.find_by_name(%{Introducing HTML 5 (Voices That Matter)})
Product.find_by_name(%{jQuery}).related_products.push Product.find_by_name(%{jQuery Cookbook})
Product.find_by_name(%{jQuery}).related_products.push Product.find_by_name(%{jQuery Pocket Reference})
Product.find_by_name(%{jQuery}).related_products.push Product.find_by_name(%{jQuery in Action, Second Edition})
Product.find_by_name(%{ABC Products Rechargeable Lithium-Ion Battery Li50b}).related_products.push Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case})
Product.find_by_name(%{Ex-Pro Olympus Li-50b, Li50b, High Power Plus+ 925mAh 2}).related_products.push Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case})
Product.find_by_name(%{Ex-Pro Olympus Li-50b, Li50b, High Power Plus+ 925mAh 2}).related_products.push Product.find_by_name(%{Olympus TRHC-120 Traveller Hard Case})
Product.find_by_name(%{Ex-Pro Olympus Li-50B, Li50b Digital Camera Battery}).related_products.push Product.find_by_name(%{Olympus TRHLC-120 Traveller Hard Leather Case})
Product.find_by_name(%{Olympus Traveller Accessory Kit 50B for SZ-10}).related_products.push Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card})
Product.find_by_name(%{Energizer CA5L Digital Camera Battery Equivalent to}).related_products.push Product.find_by_name(%{Lowepro Rezo 30 Digital Camera Pouch - Burnt Orange})
Product.find_by_name(%{SANDISK 8 GB Secure Digital SDHC Card - Frustration Free Packaging}).related_products.push Product.find_by_name(%{Panasonic DMW-PSS13KK Leather Case for FS Series})
Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).related_products.push Product.find_by_name(%{Nikon D3100 18-55vr Kit})
Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).related_products.push Product.find_by_name(%{Nikon D3100 Digital Field Guide})
Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{AmazonBasics Wireless Remote Control for Nikon P7000}).related_products.push Product.find_by_name(%{Nikon D3100 18-55vr Kit})
Product.find_by_name(%{AmazonBasics Wireless Remote Control for Nikon P7000}).related_products.push Product.find_by_name(%{Nikon D7000 Body Only})
Product.find_by_name(%{AmazonBasics Wireless Remote Control for Nikon P7000}).related_products.push Product.find_by_name(%{Nikon D90 Body Only})
Product.find_by_name(%{Nikon D3100}).related_products.push Product.find_by_name(%{Nikon D3100 18-55vr Kit})
Product.find_by_name(%{Nikon D3100}).related_products.push Product.find_by_name(%{Nikon D3100 Digital Field Guide})
Product.find_by_name(%{Nikon D3100}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{Nikon D3100}).related_products.push Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera})
Product.find_by_name(%{Nikon D3100 Digital Field Guide}).related_products.push Product.find_by_name(%{Nikon D3100 18-55vr Kit})
Product.find_by_name(%{Nikon D3100 Digital Field Guide}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{Nikon D3100 Digital Field Guide}).related_products.push Product.find_by_name(%{Hama Starter Kit for Nikon D3100 Camera})
Product.find_by_name(%{Lowepro Nova 160 AW All Weather Shoulder Bag for}).related_products.push Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card})
Product.find_by_name(%{Lowepro Nova 160 AW All Weather Shoulder Bag for}).related_products.push Product.find_by_name(%{Nikon D3100 18-55vr Kit})
Product.find_by_name(%{SquareTrade 3-Year Warranty Plus Accident Protection}).related_products.push Product.find_by_name(%{Panasonic DMW-PSS13KK Leather Case for FS Series})
Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000}).related_products.push Product.find_by_name(%{Nikon D3000 Digital Field Guide})
Product.find_by_name(%{Nikon D3000 For Dummies For Dummies Lifestyles Paperback}).related_products.push Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000})
Product.find_by_name(%{Nikon D3000 For Dummies For Dummies Lifestyles Paperback}).related_products.push Product.find_by_name(%{Nikon D3000 Digital Field Guide})
Product.find_by_name(%{Lig0sh}).related_products.push Product.find_by_name(%{Nikon D90 Body Only})
Product.find_by_name(%{Lig0sh}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{Nikon D3000}).related_products.push Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000})
Product.find_by_name(%{Nikon D3000}).related_products.push Product.find_by_name(%{Nikon D3000 Digital Field Guide})
Product.find_by_name(%{Nikon D3000 Digital Field Guide}).related_products.push Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D300S, D3000})
Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).related_products.push Product.find_by_name(%{Transcend 16GB SDHC Class 10 Memory Card})
Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).related_products.push Product.find_by_name(%{Nikon D5100 Digital Field Guide})
Product.find_by_name(%{Gem Easy Access SLR Camera Case for Nikon D5100, D7000}).related_products.push Product.find_by_name(%{Nikon D7000 18-105 VR Kit})
Product.find_by_name(%{Nikon D5100 For Dummies (For Dummies (Computers))}).related_products.push Product.find_by_name(%{Nikon D5100 Digital Field Guide})
Product.find_by_name(%{Nikon D5100 For Dummies (For Dummies (Computers))}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{Nikon D5100 Digital Field Guide}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{Nikon D5100 Digital Field Guide}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{Nikon AF-S DX NIKKOR 55-300mm f/4.5-5.6G VR Lens}).related_products.push Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602})
Product.find_by_name(%{Nikon AF-S DX NIKKOR 55-300mm f/4.5-5.6G VR Lens}).related_products.push Product.find_by_name(%{Nikon D3100 18-55vr Kit})
Product.find_by_name(%{Nikon Li-on batteri EN-EL14, VFB10602}).related_products.push Product.find_by_name(%{Nikon D3100 18-55vr Kit})
Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).related_products.push Product.find_by_name(%{Nikon D7000 Body Only})
Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702}).related_products.push Product.find_by_name(%{Nikon D7000 Digital Field Guide})
Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).related_products.push Product.find_by_name(%{Nikon D7000 Body Only})
Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).related_products.push Product.find_by_name(%{Nikon D90 Body Only})
Product.find_by_name(%{Nikon 18-200mm F3.5-5.6G IF-ED AF-S VR II DX Lens}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).related_products.push Product.find_by_name(%{Nikon D7000 Body Only})
Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).related_products.push Product.find_by_name(%{Nikon D7000 Digital Field Guide})
Product.find_by_name(%{Neewer Vertical Battery Grip for Nikon D7000 Digital}).related_products.push Product.find_by_name(%{Nikon D7000 18-105 VR Kit})
Product.find_by_name(%{Nikon AF-S DX 16-85MM}).related_products.push Product.find_by_name(%{Nikon D7000 Body Only})
Product.find_by_name(%{Nikon AF-S DX 16-85MM}).related_products.push Product.find_by_name(%{Hoya 67mm Pro-1 Digital UV Screw in Filter})
Product.find_by_name(%{David Busch's Nikon D7000 Guide to Digital SLR Photography}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{David Busch's Nikon D7000 Guide to Digital SLR Photography}).related_products.push Product.find_by_name(%{Nikon D7000 Body Only})
Product.find_by_name(%{David Busch's Nikon D7000 Guide to Digital SLR Photography}).related_products.push Product.find_by_name(%{Nikon D7000 Digital Field Guide})
Product.find_by_name(%{Nikon AF-S DX 35mm f1.8G}).related_products.push Product.find_by_name(%{Nikon D7000 Body Only})
Product.find_by_name(%{Nikon AF-S DX 35mm f1.8G}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}).related_products.push Product.find_by_name(%{Nikon D7000 Digital Field Guide})
Product.find_by_name(%{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}).related_products.push Product.find_by_name(%{Nikon D7000 18-105 VR Kit})
Product.find_by_name(%{Nikon D7000 For Dummies For Dummies Lifestyles Paperback}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{Nikon D7000 Digital Field Guide}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{Nikon D7000 Digital Field Guide}).related_products.push Product.find_by_name(%{Nikon D7000 18-105 VR Kit})
Product.find_by_name(%{Nikon ML-L3 Remote Control}).related_products.push Product.find_by_name(%{Nikon Li-ion battery EN-EL15, VFB10702})
Product.find_by_name(%{Nikon ML-L3 Remote Control}).related_products.push Product.find_by_name(%{Nikon D5100 Digital Field Guide})
Product.find_by_name(%{Nikon 50mm F1.8D AF Nikkor Lens}).related_products.push Product.find_by_name(%{Nikon D90 Body Only})
Product.find_by_name(%{Nikon EN-EL3e Rechargeable Battery}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{Nikon D90 For Dummies}).related_products.push Product.find_by_name(%{The Nikon D90 Companion})
Product.find_by_name(%{Nikon D90 For Dummies}).related_products.push Product.find_by_name(%{Nikon D90 Body Only})
Product.find_by_name(%{Nikon D90 For Dummies}).related_products.push Product.find_by_name(%{Nikon EN-EL3e Rechargeable Battery})
Product.find_by_name(%{Nikon D90 For Dummies}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{The Nikon D90 Companion}).related_products.push Product.find_by_name(%{Nikon D90 For Dummies})
Product.find_by_name(%{The Nikon D90 Companion}).related_products.push Product.find_by_name(%{Nikon D90 Body Only})
Product.find_by_name(%{The Nikon D90 Companion}).related_products.push Product.find_by_name(%{Nikon ML-L3 Remote Control})
Product.find_by_name(%{WD My Book Live Personal Cloud Storage 2 TB Network Attached Storage}).related_products.push Product.find_by_name(%{Western Digital TV Live HD Media Player})
Product.find_by_name(%{Belkin F8N204EA Providence Street Case for Notebooks Up to 15.6 inch - Black}).related_products.push Product.find_by_name(%{Microsoft Office 2010 Home and Student, 3 Users (PC)})
Product.find_by_name(%{Office for Mac 2011, Home and Student Edition (1 User, 1Mac)}).related_products.push Product.find_by_name(%{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black})
Product.find_by_name(%{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (900-1000 Items)}).related_products.push Product.find_by_name(%{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi})
Product.find_by_name(%{SquareTrade 3-Year Laptop Warranty Plus Accident Protection (900-1000 Items)}).related_products.push Product.find_by_name(%{13.3" Inch Apple Macbook Soft Carry Case Sleeve - Black})
Product.find_by_name(%{AppleCare Protection Plan for 13 inch MacBook/MacBook Air/MacBook Pro}).related_products.push Product.find_by_name(%{LArobe Black Addict MacBook 13.3 Inch - Black + Wasabi})
Product.find_by_name(%{Network Fundamentals, CCNA Exploration Labs and Study Guide Cisco Networking Academy
      Program}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{Clean Code}).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Refactoring}).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Programming Pearls (ACM Press)}).related_products.push Product.find_by_name(%{Introduction to Algorithms})
Product.find_by_name(%{Programming Pearls (ACM Press)}).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Design patterns }).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Design patterns }).related_products.push Product.find_by_name(%{Head First Design Patterns})
Product.find_by_name(%{Slack }).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Head First Design Patterns}).related_products.push Product.find_by_name(%{Head First Java})
Product.find_by_name(%{Java How to Program}).related_products.push Product.find_by_name(%{Java Pocket Guide (Pocket Guides)})
Product.find_by_name(%{Java How to Program}).related_products.push Product.find_by_name(%{Head First Java})
Product.find_by_name(%{UML Distilled}).related_products.push Product.find_by_name(%{Java for Everyone})
Product.find_by_name(%{Head First Java}).related_products.push Product.find_by_name(%{Head First Design Patterns})
Product.find_by_name(%{Head First Java}).related_products.push Product.find_by_name(%{Java Pocket Guide (Pocket Guides)})
Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).related_products.push Product.find_by_name(%{C++ Pocket Reference})
Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{Java Pocket Guide (Pocket Guides)}).related_products.push Product.find_by_name(%{Head First Java})
Product.find_by_name(%{C++ Pocket Reference}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{C++ Pocket Reference}).related_products.push Product.find_by_name(%{Java Pocket Guide (Pocket Guides)})
Product.find_by_name(%{Python Pocket Reference Pocket Reference O'Reilly}).related_products.push Product.find_by_name(%{C++ Pocket Reference})
Product.find_by_name(%{bash Pocket Reference Pocket Reference O'Reilly}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{Artificial Intelligence}).related_products.push Product.find_by_name(%{Introduction to Algorithms})
Product.find_by_name(%{Operating Systems Design and Implementation}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Operating Systems Design and Implementation}).related_products.push Product.find_by_name(%{Introduction to Algorithms})
Product.find_by_name(%{Concepts, Techniques, and Models of Computer Programming}).related_products.push Product.find_by_name(%{The Pragmatic Programmer})
Product.find_by_name(%{Computer Networks}).related_products.push Product.find_by_name(%{Introduction to Algorithms})
Product.find_by_name(%{C++}).related_products.push Product.find_by_name(%{C++ Pocket Reference})
Product.find_by_name(%{C Programming in Easy Steps}).related_products.push Product.find_by_name(%{C for Dummies})
Product.find_by_name(%{C for Dummies}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{C for Dummies}).related_products.push Product.find_by_name(%{C Programming in Easy Steps})
Product.find_by_name(%{C for Dummies}).related_products.push Product.find_by_name(%{Absolute Beginner's Guide to C (Other Sams)})
Product.find_by_name(%{C. Puzzle Book}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{C. Puzzle Book}).related_products.push Product.find_by_name(%{C. Answer Book (Prentice Hall Software)})
Product.find_by_name(%{C. Puzzle Book}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{C. Puzzle Book}).related_products.push Product.find_by_name(%{Expert C Programming})
Product.find_by_name(%{C Programming}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{C Programming}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{Expert C Programming}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Expert C Programming}).related_products.push Product.find_by_name(%{C Pocket Reference})
Product.find_by_name(%{Advanced Programming in the UNIX Environment Addison-Wesley Professional Computing}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Computer Architecture}).related_products.push Product.find_by_name(%{Introduction to Algorithms})
Product.find_by_name(%{Systems Analysis and Design with UML}).related_products.push Product.find_by_name(%{Java for Everyone})
Product.find_by_name(%{Learning to Program with Alice (w/CD-ROM)}).related_products.push Product.find_by_name(%{Computer Science Illuminated})
Product.find_by_name(%{The Essentials of Computer Organization and Architecture}).related_products.push Product.find_by_name(%{Java for Everyone})
Product.find_by_name(%{Discrete Mathematics and Its Applications with MathZone}).related_products.push Product.find_by_name(%{Java for Everyone})
Product.find_by_name(%{Discrete Mathematics and Its Applications with MathZone}).related_products.push Product.find_by_name(%{C Programming in Easy Steps})
Product.find_by_name(%{Object-Oriented Analysis and Design}).related_products.push Product.find_by_name(%{Java for Everyone})
Product.find_by_name(%{Human Computer Interaction}).related_products.push Product.find_by_name(%{The C Programming Language (2nd Edition)})
Product.find_by_name(%{Applying UML and Patterns}).related_products.push Product.find_by_name(%{Head First Design Patterns})
